...
export const ORDER_PRESETS: OrderPreset[] = [
  {
    ...
    values: {
      ...
      notes:
        "用途是 Network，联结 YNd11yn12；OS 写 CV2-500 和选择器 C，向导按目录 CV2 350 起，漆 RAL 7033、防腐 C4-H。",
    },
  },
  {
    id: "hlg-havec-cv",
    ...
    values: {
      ...
      notes:
        "自耦变，27 档 −20/+6%（向导只能按 14271W 正反）；通过电流 300 A，开关按目录 CV-350。",
    },
  },
  {
    id: "ue-hwv",
  ...
  },
  {
    ...
    values: {
      ...
      drive_shaft_horizontal_mm: "2000",
      drive_shaft_vertical_mm: "2000",
      notes: "配 CMA7 和 SHM-KX；H2S 环境，漆按 C5-M。",
    },
  },
];
