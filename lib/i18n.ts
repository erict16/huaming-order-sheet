...
const chrome = {
  ...
  reviewLead: L("下载华明订货规范书（Word）。空白项按常规。", "Downloads the Huaming Word order sheet. Blank = standard.", "Скачивается бланк Word. Пусто = стандарт.", "Tải phiếu Word. Trống = tiêu chuẩn."),
