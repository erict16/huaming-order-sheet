...
const chrome = {
  ...
  heroLead: L(
    "按华明五类规格表填写。型号会跟着参数自动拼出来。空白项按常规配置供货。全部在浏览器里完成，不会上传到服务器。",
    "Fill the five Huaming specification sheets. The type string updates as you type. Blank fields mean standard supply. Everything stays in your browser.",
    "Пять бланков Huaming. Обозначение собирается само. Пустые поля — стандартная поставка. Всё в браузере, без загрузки на сервер.",
    "Điền năm phiếu Huaming. Chuỗi kiểu máy tự ghép. Ô trống = cấu hình tiêu chuẩn. Tất cả trong trình duyệt, không tải lên máy chủ.",
  ),
  ...
  export: L("下载 Excel", "Download Excel", "Скачать Excel", "Tải Excel"),
  ...
  reviewLead: L("导出给国内订单处理 / 工程用。列名稳定，机器和人都能读。", "For order processing and engineering in China. Stable columns, human- and machine-readable.", "Для обработки заказов и конструкторов. Стабильные колонки.", "Cho xử lý đơn và kỹ thuật. Cột ổn định, người và máy đều đọc được."),
