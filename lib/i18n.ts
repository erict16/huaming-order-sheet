...
const chrome = {
  ...
  reviewLead: L("核对后选择导出 Word 或 Excel。空白项按常规。", "Choose Word or Excel export after review. Blank = standard.", "После проверки выберите Word или Excel. Пусто = стандарт.", "Sau khi kiểm tra, chọn Word hoặc Excel. Trống = tiêu chuẩn."),
